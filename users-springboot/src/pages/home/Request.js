...
const Request = () => {
    return(
        <section class="padding-bottom">
            ...
            <div class="row">
                <div class="col-md-8">
            <div class="card-banner banner-quote overlay-gradient" style={{ backgroundImage: "url('images/banners/banner9.jpg')" }}>
            ...
            <div class="card card-body">
                ...
                <form>
                    ...
                    <div class="form-group text-muted">
                        ...
                        <dspaniv class="form-check-label">Request a sample</dspaniv>
                        </label>
                    </div>
                    <div class="form-group">
