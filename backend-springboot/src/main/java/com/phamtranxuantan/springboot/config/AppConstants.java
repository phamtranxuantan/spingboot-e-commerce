...
public class AppConstants {
  ...
  public static final String[] PUBLIC_URLS = { "/v3/api-docs/**", "/swagger-ui/**", "/api/register", "/api/login", "/api/public/oauth2/**","/api/public/users/imageUser/**","/ws/**","/chat/**","/api/public/ask",
      "/api/public/products/imageProduct/**" };
